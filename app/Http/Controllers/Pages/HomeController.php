...
class HomeController extends Controller
{
    ...
    public function showEventDetail(Request $request, $id){
        $eventController = app()->make(ServiceEventController::class);
        $eventDetail = $eventController->dataCacheFile(null, 1, ['id', 'eventid', 'eventname', 'eventdescription', 'eventdetail', 'startdate', 'enddate', 'is_free' , 'link_event', 'imageicon_1', 'imageicon_2', 'imageicon_3', 'imageicon_4', 'imageicon_5', 'imageicon_6', 'imageicon_7', 'imageicon_8', 'category'], ['id', 'event_id', 'event_name', 'event_description', 'event_detail', 'start_date', 'end_date', 'is_free', 'link_event', 'img', 'img', 'img', 'img', 'img', 'img', 'img', 'img', 'category'], true, ['flow' => 'search', 'search' => ['keywoard' => $id, 'fields' => ['eventid'], 'case_sensitive' => true]], false);
